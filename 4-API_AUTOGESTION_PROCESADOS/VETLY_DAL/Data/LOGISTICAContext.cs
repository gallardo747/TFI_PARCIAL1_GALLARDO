...
namespace LOGISTICA_DAL.Data
{
    public partial class LOGISTICAContext : DbContext
    {
        ...
        public virtual DbSet<DocumentoARegistrar> DocumentoARegistrar { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DocumentoARegistrar>(entity =>
            {
                ...
                entity.Property(e => e.Fecha_Insercion).HasColumnType("datetime");
            });
